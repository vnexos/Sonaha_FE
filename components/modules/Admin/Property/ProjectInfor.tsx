...
const ProjectInfor: FC<Props> = ({
    ...
    // const { data } = useGetHeroDataQuery("properties", {});
        ...
        if (file) {
            ...
            reader.onload = (e: any) => {
                if (reader.readyState === 2) {
                    setProjectInfo({ ...ProjectInfo, thumbnail: reader.result });
                }
            };
                ...
                <div className="w-full flex justify-between">
                    <div className="w-[45%]">
                        ...
                        <input
                            ...
                            onChange={(e: any) =>
                                setProjectInfo({ ...ProjectInfo, price: e.target.value })
                            }
                            id="price"
                            placeholder="29"
                            className={`
            ${styles.input}`}
                    ...
                    <div className="w-[50%]">
                        ...
                        <input
                            type="number"
                            name=""
                            value={ProjectInfo.estimatedPrice}
                            onChange={(e: any) =>
                                setProjectInfo({ ...ProjectInfo, estimatedPrice: e.target.value })
                            }
                            id="price"
                            placeholder="79"
                            className={`
                ...
                <div className="w-full flex justify-between">
                    <div className="w-[45%]">
                        ...
                        <input
                            ...
                            required
                            onChange={(e: any) =>
                                setProjectInfo({ ...ProjectInfo, level: e.target.value })
                            }
                            id="level"
            ...
            ${styles.input}`}
                    ...
                    <div className="w-[50%]">
                        ...
                        <input
                            ...
                            name=""
                            required
                            value={ProjectInfo.demoUrl}
                            onChange={(e: any) =>
                                setProjectInfo({ ...ProjectInfo, demoUrl: e.target.value })
                            }
                            id="demoUrl"
                            placeholder=""
                            className={`
