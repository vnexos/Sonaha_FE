...
export const CreateProperty = ({
  ...
  const [createdPropertyId] = useState<number | null>(null);
  ...
  return (
    <>
              ...
              <ModalBody>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Select
                    ...
                    name="furniture"
                    selectedKeys={
                      formData.furniture ? [formData.furniture] : []
                    }
                    onSelectionChange={(keys) => {
                      const selectedKey = Array.from(keys)[0] as string;
      ...
      {step === "upload" && createdPropertyId && (
        <CreateAlbum
          propertyId={createdPropertyId}
          onComplete={() => {
            setStep("create"); // Quay lại bước đầu khi upload xong
            onClose(); // Đóng modal
          }}
        />
      )}
